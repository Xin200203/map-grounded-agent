#!/usr/bin/env bash
# Launch the R2 robust-centroid cross-48 suite: 4 lanes
...
launch_lane 4 "${EXP36}"   "results/r2_exp36_${STAMP}"   smoothnav-full        "results/r2_exp36_${STAMP}/driver_full.log"
launch_lane 5 "${EXP36}"   "results/r2_exp36_${STAMP}"   smoothnav-no-prefetch "results/r2_exp36_${STAMP}/driver_np.log"
