...
- Step 31: B1:V=0.41/geometry_only, B2:V=0.41/geometry_only, B3:V=0.34/geometry_only; counts={'direct': 0, 'anchor': 0, 'room_prior': 0, 'geometry_only': 3}
- Step 43: B1:V=0.41/geometry_only, B2:V=0.41/geometry_only; counts={'direct': 0, 'anchor': 0, 'room_prior': 0, 'geometry_only': 2}
- Step 98: B2:V=0.41/geometry_only, B3:V=0.41/geometry_only, B1:V=0.06/geometry_only; counts={'direct': 0, 'anchor': 0, 'room_prior': 0, 'geometry_only': 3}
- Step 145: B5:V=0.96/anchor, B6:V=0.85/anchor, B4:V=0.77/anchor, B3:V=0.41/anchor, B2:V=0.12/geometry_only, B1:V=0.00/geometry_only; counts={'direct': 0, 'anchor': 4, 'room_prior': 0, 'geometry_only': 2}
