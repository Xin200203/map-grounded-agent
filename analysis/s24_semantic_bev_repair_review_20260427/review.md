...
| ---: | --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | --- |
| 31 | B2 |  | B2 | True | 0 | 0 | none:0 | 3 | 0 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:25.0, semantic_channels_present_but_empty, direct_target_semantic_channel_empty |
| 43 | B2 | B1 | B1 | True | 0 | 0 | none:0 | 2 | 1 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:25.0, semantic_channels_present_but_empty, direct_target_semantic_channel_empty |
| 98 | B1 | B3 | B3 | True | 1 | 1 | none:0 | 3 | 0 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:113.0, direct_target_semantic_channel_empty |
