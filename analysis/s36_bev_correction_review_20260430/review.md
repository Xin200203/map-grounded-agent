...
| ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- |
| 31 | B2 |  | B2 | True | empty_map_channels | 0.0000 | 0 | 0 | 0 | none:0 | 3 | 0 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:25.0, semantic_channels_present_but_empty, direct_target_semantic_channel_empty, target_value_geometry_only |
| 43 | B2 | B1 | B1 | True | empty_map_channels | 0.0000 | 0 | 0 | 0 | none:0 | 2 | 1 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:25.0, semantic_channels_present_but_empty, direct_target_semantic_channel_empty, target_value_geometry_only |
| 98 | B1 | B3 | B3 | True | map_channels | 0.0000 | 23 | 1 | 1 | none:0 | 3 | 0 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:113.0, direct_target_semantic_channel_empty, target_value_geometry_only |
| 145 | B4 | B4 | B4 | True | map_channels | 0.0001 | 50 | 3 | 9 | semantic_prior_only:19 | 6 | 0 | agent_display_coord_repaired_from_map_current_channel, raw_agent_coord_disagrees_with_map_current_channel:93.0, direct_target_semantic_channel_empty, target_heatmap_uses_prior_not_direct_target |
...
- Step 145: B6:H=0.67/A=0.67, B4:H=0.35/A=0.35, B3:H=0.00/A=0.23, B5:H=0.00/A=0.19, B1:H=0.00/A=0.08, B2:H=0.00/A=0.08
...
- Step 145: B6:V=1.00/anchor, B4:V=0.54/anchor, B3:V=0.38/geometry_only, B5:V=0.38/geometry_only, B2:V=0.01/geometry_only, B1:V=0.00/geometry_only; counts={'direct': 0, 'anchor': 2, 'room_prior': 0, 'geometry_only': 4}
...
- Dense semantic BEV: `step_000031/dense_semantic_bev.png`
- Dense semantic BEV JSON: `step_000031/dense_semantic_bev.json`
- Debug overlay full: `step_000031/debug_overlay_full.png`
...
- Dense semantic BEV: `step_000043/dense_semantic_bev.png`
- Dense semantic BEV JSON: `step_000043/dense_semantic_bev.json`
- Debug overlay full: `step_000043/debug_overlay_full.png`
...
- Dense semantic BEV: `step_000098/dense_semantic_bev.png`
- Dense semantic BEV JSON: `step_000098/dense_semantic_bev.json`
- Debug overlay full: `step_000098/debug_overlay_full.png`
